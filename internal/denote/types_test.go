...
func TestValidateIdea(t *testing.T) {
	...
	i.RejectedReason = "Too expensive"
	...
	i4 := &Idea{}
	i4.State = StateActive
	if err := ValidateIdea(i4); err != nil {
	...
	i5 := &Idea{}
	i5.State = "bogus"
	if err := ValidateIdea(i5); err == nil {
		t.Error("expected error for invalid state")
	}

	// Invalid maturity
	i6 := &Idea{}
	i6.State = StateActive
	i6.Maturity = "sprint"
	if err := ValidateIdea(i6); err == nil {
